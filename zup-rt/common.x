MEMORY
{
  ATCM0   : ORIGIN = 0x00000000, LENGTH = 32K
  ATCM1   : ORIGIN = 0x00008000, LENGTH = 32K
...
PROVIDE(PL_PS_00 = DefaultHandler);
PROVIDE(PL_PS_01 = DefaultHandler);
PROVIDE(PL_PS_02 = DefaultHandler);
PROVIDE(PL_PS_03 = DefaultHandler);
PROVIDE(PL_PS_04 = DefaultHandler);
PROVIDE(PL_PS_05 = DefaultHandler);
PROVIDE(PL_PS_06 = DefaultHandler);
PROVIDE(PL_PS_07 = DefaultHandler);
